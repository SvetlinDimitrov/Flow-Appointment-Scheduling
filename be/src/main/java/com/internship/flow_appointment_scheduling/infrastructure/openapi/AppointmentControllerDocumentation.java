...
public interface AppointmentControllerDocumentation {
  ...
  @Operation(
      ...
      description = "Retrieve a paginated list of all appointments")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Found the appointments",
            content = {
              @Content(
  ...
  @Operation(
      summary = "Get all appointments by service ID",
      description = "Retrieve a paginated list of all appointments for a specific service")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      summary = "Get all short appointments by service ID and date",
      description =
          "Retrieve a list of all short appointments for a specific service on a given date")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            ...
            content = {
              @Content(
                  mediaType = "application/json",
                  array =
                      @ArraySchema(schema = @Schema(implementation = ShortAppointmentView.class)))
            }),
        @ApiResponse(
            responseCode = "403",
            description = "Forbidden",
  ...
  @Operation(
      ...
      description = "Retrieve a paginated list of all appointments for a specific user")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  ResponseEntity<Page<AppointmentView>> getAllByUserId(
      @Parameter(description = "ID of the user") @PathVariable Long userId, Pageable pageable);

  @Operation(
      summary = "Get all short appointments by user ID and date",
      description = "Retrieve a list of all short appointments for a specific user on a given date")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Found the appointment",
            content = {
              @Content(
                  mediaType = "application/json",

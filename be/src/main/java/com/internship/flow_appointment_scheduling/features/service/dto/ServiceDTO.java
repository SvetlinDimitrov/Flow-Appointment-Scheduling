...
public record ServiceDTO(
    ...
    @NotNull(message = "Price is mandatory")
        ...
        BigDecimal price,
    @NotNull(message = "Duration is mandatory") @NonNegativeDuration Duration duration,
    @NotBlank(message = "WorkSpace name is mandatory") @ValidWorkSpaceName String workSpaceName) {}
